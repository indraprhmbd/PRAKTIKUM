...
int main (){
    ...
    string user,pass,namaBarang1,namaBarang2,namaBarang3,namaBarang4;
    char idBarang1[6],idBarang2[6],idBarang3[6],idBarang4[6],inputId[6];
    bool lanjut,valid1=false,ulang;
